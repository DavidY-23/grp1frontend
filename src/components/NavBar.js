...
const NavBar = (props) => {
  ...
  const [useringredient_names, set_ingredient_names] = useState(
    props.ingredient_names
  );
  const [useringredients_to_avoid, set_ingredients_to_avoid] = useState(
    props.ingredients_to_avoid
  );
    ...
    <div className="container-fluid sticky-top side-nav-bar">
      ...
      <div className="row">
        ...
        <Link to="/home/MentalHealth">
          <div
            className={
              props.selected === "MentalHealth" ? "selected-nav-tab" : ""
            }
          >
            Mental Health
          </div>
